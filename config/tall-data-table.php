...
return [
    ...
    'tbodyClass' => env('TABLE_TBODY_CLASS', 'divide-y divide-y-8 divide-blue-500 md:table-row-group'),
    ...
    'groupedTdClass' => env('TABLE_GROUPED_TD_CLASS', 'align-middle flex items-center md:block px-2 whitespace-normal'),
    'groupClass' => env('TABLE_GROUPED_CLASS', 'inline-grid grid-cols-3 gap-2 md:table-cell'),
