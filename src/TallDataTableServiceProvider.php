...
class TallDataTableServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        ...
        $this->publishes([__DIR__ . '/../config/tall-data-table.php' => config_path('tall-data-table.php')], 'tall-data-table');
        $this->publishes([__DIR__ . '/../resources/views' => resource_path('views/vendor/tall-data-table')], 'tall-data-table');
    }
