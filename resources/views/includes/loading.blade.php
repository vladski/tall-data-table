<div class="flex items-center w-full">
    <div class="mx-auto my-auto py-20" wire:loading wire:target="{{$target}}">
        <svg focusable="false" stroke="currentColor" class="w-24 h-24" viewBox="0 0 57 57"
            xmlns="http://www.w3.org/2000/svg" class="q-spinner text-red">
